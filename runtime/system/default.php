...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <h4>管理员信息</h4>
   <ul class="square">
   	<li><b>管理员名称：</b><?php echo isset($this->admin['admin_name'])?$this->admin['admin_name']:"";?></li>
   </ul>
   <h4>网站信息</h4>
   <ul class="square">
      <li><b>网站名称：</b><?php echo isset($this->confRow['name'])?$this->confRow['name']:"";?></li>
      <li><b>网站地址：</b><a href="<?php echo isset($this->confRow['url'])?$this->confRow['url']:"";?>" target="_blank"><?php echo isset($this->confRow['url'])?$this->confRow['url']:"";?></a></li>
   </ul>
</div>
			</div>
			<!-- end content / right -->
