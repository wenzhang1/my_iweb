...
<div class="box">
   <div class="title">
      <h5>公告管理-><?php if(isset($this->noticeRow['id'])){?>编辑<?php }else{?>添加<?php }?>公告</h5>
   </div>
   <div class="form">
      <form action="<?php echo IUrl::creatUrl("/tools/notice_edit_act");?>" method="post">
         <div class="fields">
           <div class="field">
              <div class="label">
              ...
              <div class="input">
                 <input type="hidden" name="id" value="<?php echo isset($this->noticeRow['id'])?$this->noticeRow['id']:"";?>"/>
                 <input type="text" class="small" name="title" id="title" value="<?php echo isset($this->noticeRow['title'])?$this->noticeRow['title']:"";?>" />
              </div>
           </div>
           <div class="field">
              <div class="label label-textarea"><label for="text_content">内容：</label></div>
              <div class="textarea textarea-editor">
                 <textarea name="text_content" id="text_content" style="height:300px;width:600px"><?php echo htmlspecialchars($this->noticeRow['content']);?></textarea>
              </div>
           </div>
           <div class="buttons">
