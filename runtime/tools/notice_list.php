...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <div class="title">
      <h5>公告列表</h5>
      <ul class="links">
         <li><a href="<?php echo IUrl::creatUrl("/tools/notice_edit");?>">添加新公告</a></li>
      </ul>
   </div>
   <form action="<?php echo IUrl::creatUrl("/tools/notice_del");?>" method="post">
      <div class="table">
         <table>
            <col width="45%" />
            <col width="33%" />
            ...
            <tbody>
               ...
               <?php $query = new IQuery("notice");$query->order = "create_time DESC";$query->page = "$page";$query->pagesize = "10";$items = $query->find(); foreach($items as $key => $item){?>
               <tr>
                  <td class="title"><b><?php echo isset($item['title'])?$item['title']:"";?></b></td>
                  <td class="date"><?php echo isset($item['create_time'])?$item['create_time']:"";?></td>
                  <td class="operation">
                     <a href="<?php echo IUrl::creatUrl("/tools/notice_edit/id/$item[id]");?>">编辑公告</a>
                     <a href="javascript:void(0)" onclick="delModel({link:'<?php echo IUrl::creatUrl("/tools/notice_del/id/$item[id]");?>'})">删除公告</a>
                  </td>
                  <td class="last">
