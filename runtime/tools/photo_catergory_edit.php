	...
	<body>
		...
		<div id="content">
			...
			<div id="right">
				<div class="box">
   <div class="title">
      <h5>相册管理-><?php if(isset($this->photoCatRow['id'])){?>编辑<?php }else{?>添加<?php }?>相册</h5>
   </div>
   <div class="form">
      <form action="<?php echo IUrl::creatUrl("/tools/photo_category_edit_act");?>" method="post">
         <div class="fields">
           <div class="field">
              <div class="label">
              ...
              <div class="input">
                 <input type="hidden" name="id" value="<?php echo isset($this->photoCatRow['id'])?$this->photoCatRow['id']:"";?>"/>
                 <input type="text" class="small" name="name" id="name" value="<?php echo isset($this->photoCatRow['name'])?$this->photoCatRow['name']:"";?>" />
              </div>
           </div>
           <div class="buttons">
