...
function addImage(src) {
	...
	{
		//最外层的span
		var upSpan = $('<div class="pic" id=\'a'+arr[3]+'\'></div>');
		//显示的图片
		var claname = '';
		if(focus_photo=='')
		{
		...
		var imgSrc = $('<input type="hidden" value="'+arr[2]+'" name="src[]">').appendTo(upSpan);
		var forea = $('<a href="javascript:void(0)" style="padding-right:1em" onclick="focus_img(\''+arr[2]+'\',this);">设为封面</a>').appendTo(upSpan);
		var downa = $('<a href="javascript:void(0);" id=\''+arr[3]+'\' onclick="del_img(this.id);">删除</a>').appendTo(upSpan);
