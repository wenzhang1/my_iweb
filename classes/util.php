...
class Util
{
	...
	/**
	 * @brief 显示确认框(confirm框)
	 * @param string $message 信息提示字符
	 */
	public static function delMessage($conf,$message){
		echo '<script type="text/javascript">delModel('.$conf.',"'.$message.'")</script>';
		exit;
	}
